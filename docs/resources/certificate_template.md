...
- `allowed_enrollment_types` (Number) Bitmask of allowed enrollment types: 0=none (disabled), 1=PFX, 2=CSR, 3=both. Setting to 0 effectively disables the template. **Deprecated in Command v25+** (use enrollment patterns instead).
