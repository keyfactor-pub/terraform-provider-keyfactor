...
const (
	...
	DEFAULT_CERTIFICATE_CSR_ENROLLMENT_FORMAT = "PEM"
	DEFAULT_CERTIFICATE_RECOVER_FORMAT        = "PFX"
...
var VALID_CSR_CERTIFICATE_FORMATS = []string{"PEM", "DER"}
